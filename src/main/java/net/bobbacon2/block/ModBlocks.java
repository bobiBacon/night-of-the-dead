...
public class ModBlocks {
    ...
    public static final Block ANCIENT_PEDESTAL = registryHelper.register("ancient_pedestal",new AncienPedestal(FabricBlockSettings.create().requiresTool().sounds(BlockSoundGroup.STONE).instrument(Instrument.BASS).strength(2.5F)));
