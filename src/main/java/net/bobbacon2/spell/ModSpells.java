...
public class ModSpells {
    ...
    public static final SpellDef<?> Exorcism = registryHelper.register("exorcism",new SpellDef<>(new InstantDamageSpell(15,2, ModDamageTypes.Holy, ParticleTypes.ELECTRIC_SPARK),SpellSchools.Divine,20).setCooldown(40).useTinted2dSymbol(0xFFB900).setCastTime(20));
