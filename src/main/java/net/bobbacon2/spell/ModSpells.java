...
public class ModSpells {
    ...
    public static final SpellDef<?> SIMPLE_BLOOD_RITUAL_SPELL = Registry.register(SpellRegistry.getSpellRegistry(), Identifier.of(NightOfTheDead.MOD_ID,"simple_blood_ritual"),new SpellDef<>(new SimpleBloodRitual(), SpellSchools.Necromancy,20).useTinted2dSymbol(0xFF0000));
